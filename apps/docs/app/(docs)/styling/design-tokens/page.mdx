...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate="theme.borderRadius.{name}"
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate="theme.boxShadow.{name}"
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate='theme.colors["{name}"]'
  values={theme.colors}
/>
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate="theme.fontFamily.{name}"
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate='theme.fontSize["{name}"].{key}'
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate="theme.maxSize.{name}"
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate='theme.fontSize["{name}"]'
  values={theme.size}
/>
...
<Scale
  hidePreview
  pixelLabel="Theme"
  pixelTemplate="theme.zIndex.{name}"
  values={theme.zIndex}
/>
