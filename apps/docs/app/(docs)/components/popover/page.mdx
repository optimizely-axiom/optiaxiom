...
<KeyboardTable
  interactions={[
    {
      keys: ["Space", "Enter"],
      description: "When focus is on `PopoverTrigger`, opens the popover.",
    },
    {
      keys: "Esc",
      description: "Closes the popover and moves focus to `PopoverTrigger`.",
    },
  ]}
/>
