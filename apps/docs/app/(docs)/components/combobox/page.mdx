...
We can use virtualization to improve performance when rendering a large number of items inside the combobox. Change `children` to a render prop to enable virtualization.

<Demo component="combobox/virtualized-usage" meta="{47-51}" />
