...
Follow the [column pinning guide](https://tanstack.com/table/v8/docs/guide/column-pinning) and use the `columnPinning` option to pin columns either to the left or right side of the table.

<Demo component="data-table/sticky-column-usage" />

### Pagination

`DataTable` supports both client-side and server-side pagination. Follow the [pagination guide](https://tanstack.com/table/v8/docs/guide/pagination) to learn how to implement pagination with TanStack Table.
...
`DataTable` supports both client-side and server-side sorting. Follow the [sorting guide](https://tanstack.com/table/v8/docs/guide/sorting) to learn how to implement sorting with TanStack Table.
