...
<Demo component="data-table/loading-row-usage" />
...
### Expanding rows <Badge intent="primary">ALPHA</Badge>

Follow the [expanding guide](https://tanstack.com/table/latest/docs/guide/expanding) to allow expanding and collapsing rows.
...
<Demo component="data-table/expanding-rows-usage" />
...
<PropsTable component="DataTableAction" />

### DataTableCheckbox

<PropsTable component="DataTableCheckbox" />

### DataTableLabel

<PropsTable component="DataTableLabel" />
...
- Moved component out of **Alpha**.
  ...
  // After
  import { DataTable } from "@optiaxiom/react";
  ```
