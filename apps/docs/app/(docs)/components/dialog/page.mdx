...
<Demo component="dialog/controlled-usage" meta="{17}" />
...
<Demo meta="{16}" component="dialog/description-usage" />
...
<Demo component="dialog/trigger-usage" meta="{16-20}" />

### Form dialogs

Wrap `DialogBody` and `DialogFooter` with the `DialogForm` component to use forms in dialogs.

<Demo component="dialog/form-usage" meta="{31-41,62}" />
