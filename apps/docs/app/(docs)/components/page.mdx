...
Visit the [Style Props](/props/) section to learn more about how to consume our design tokens.
...
<Demo component="box/composition-usage" />
...
<Cards items={["Grid", "Group", "Text", "StyleProps"]} />
