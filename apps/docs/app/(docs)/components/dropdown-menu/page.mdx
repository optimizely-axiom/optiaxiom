...
<Alert intent="information" mt="16">
  Try out our new fully featured [Menu](../menu/) component that has a simpler
  API, allows filtering/selecting items, and includes built-in virtualization.
</Alert>
