...
<Demo component="menu/content-radio-switch-usage" meta="{22}" />
...
<Demo component="menu/description-usage" meta="/description/" />

### Detail

We can use the `detail` property to show secondary content in addition to item labels.

<Demo component="menu/detail-usage" meta="{23}" />
...
If the `execute` property is also present then the default link clicking behavior will be prevented (unless users use a modifier like <Kbd modifiers="mod">Enter</Kbd> to open in a new tab).
...
<Demo component="menu/link-external-usage" meta="{9}" />
...
<Cards items={["Select", "DropdownMenu"]} />
  ...
  interactions={[
    {
      keys: "Space",
      description:
        "When focus is on `MenuTrigger`, opens the menu and focuses the first item (or selected item). When focus is on an item, activates the focused item.",
    },
    {
      keys: "Enter",
      description:
        "When focus is on `MenuTrigger`, opens the menu and focuses the first item (or selected item). When focus is on an item, activates the focused item and closes the menu.",
    },
    {
      keys: "ArrowDown",
      description:
        "When focus is on `MenuTrigger`, opens the menu and focuses the first item (or selected item). When focus is on an item, moves focus to the next item.",
    },
    {
      keys: "ArrowUp",
      description:
    ...
    },
    {
      ...
      description: "Moves focus up/down by 10 items at a time.",
    },
    {
      keys: ["Home", "End"],
    ...
    {
      keys: "Esc",
      description: "Closes the menu and moves focus back to `MenuTrigger`.",
    },
  ]}
/>
