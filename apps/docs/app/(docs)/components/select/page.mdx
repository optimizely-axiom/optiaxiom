...
- [`AngleMenuButton`](/components/angle-menu-button/) (default)
- [`LabelMenuButton`](/components/label-menu-button/)
...
<Cards items={["RadioGroup", "Field", "Menu"]} />
  ...
  interactions={[
    {
      keys: ["Space", "Enter"],
      description:
        "When focus is on `SelectTrigger`, opens the menu and focuses the first item (or selected item). When focus is on an item, activates the focused item and closes the menu.",
    },
    {
      keys: "ArrowDown",
      description:
        "When focus is on `SelectTrigger`, opens the menu and focuses the first item (or selected item). When focus is on an item, moves focus to the next item.",
    },
    {
      keys: "ArrowUp",
      description:
        "When focus is on `SelectTrigger`, opens the menu and focuses the last item (or selected item). When focus is on an item, moves focus to the previous item.",
    },
    {
    ...
    {
      keys: "Esc",
      description: "Closes the menu and moves focus back to `SelectTrigger`.",
    },
  ]}
/>
