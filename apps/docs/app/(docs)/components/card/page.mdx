...
- `CardOverlay`: An optional container for checkbox and tertiary actions within the preview panel.
...
<Demo component="card/anatomy-usage" />
...
Use the `CardOverlay` component to add checkbox and other tertiary actions to cards.

<Demo component="card/overlay-usage" meta="{17-19,26-29}" />
...
<Demo component="card/overlay-action-usage" meta="{19,21,30,33}" />
