...
<Demo component={demos["avatar/fallback-name-usage"]} />

#### Children

Render `children` prop if `src` and `name` are not provided.

<Demo component={demos["avatar/fallback-children-usage"]} />
...
<Demo component={demos["avatar/fallback-icon-usage"]} />

### Grouping avatars

Use the `<AvatarGroup />` component to stack avatars together.

<Demo component={demos["avatar/group-usage"]} />

## Props

### Avatar

<PropsTable component={components["Avatar"]} />

### AvatarGroup

<PropsTable component={components["AvatarGroup"]} />
