...
<Demo component={demos["alert-dialog/usage"]} />
...
<Demo component={demos["alert-dialog/controlled-usage"]} meta="{17}" />

### Sizes

Use the `size` prop to change the size of the dialog box.

<Demo component={demos["alert-dialog/size-usage"]} meta="/size={size}/" />

### Handling confirmation

Add an `onClick` handler to `AlertDialogAction` to perform an action on confirmation.

<Demo component={demos["alert-dialog/confirmation-usage"]} meta="{42}" />
...
<Demo component={demos["alert-dialog/async-usage"]} />
...
<Demo component={demos["alert-dialog/trigger-usage"]} />
