export const demos = {
  ...
  "data-table/row-action-usage": import("./data-table/row-action-usage/App"),
  ...
  "date-picker/usage": import("./date-picker/usage/App"),
  "date-range-picker/usage": import("./date-range-picker/usage/App"),
