...
export const components = {
  ...
  Card: getProps("Card"),
  CardAction: getProps("CardAction"),
  CardCheckbox: getProps("CardCheckbox"),
  CardFooter: getProps("CardFooter"),
  CardHeader: getProps("CardHeader"),
  CardImage: getProps("CardImage"),
  CardLink: getProps("CardLink"),
  CardPreview: getProps("CardPreview"),
  ...
  DetailsPanel: getProps("DetailsPanel"),
  DetailsPanelBody: getProps("DetailsPanelBody"),
  DetailsPanelFooter: getProps("DetailsPanelFooter"),
  DetailsPanelHeader: getProps("DetailsPanelHeader"),
  ...
  FileUpload: getProps("FileUpload"),
  FileUploadDropzone: getProps("FileUploadDropzone"),
  FileUploadTrigger: getProps("FileUploadTrigger"),
  Flex: getProps("Flex"),
  Grid: getProps("Grid"),
  Heading: getProps("Heading"),
  HoverCard: getProps("HoverCard"),
  HoverCardContent: getProps("HoverCardContent"),
  HoverCardTrigger: getProps("HoverCardTrigger"),
  ...
  PillMenu: getProps("PillMenu"),
  PillMenuContent: getProps("PillMenuContent"),
  PillMenuTrigger: getProps("PillMenuTrigger"),
  ...
  SortableGroup: getProps("SortableGroup"),
