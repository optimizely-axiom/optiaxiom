...
Developers are free to choose any styling solution for components but out of the box support is provided for consuming our design tokens via style props.
...
Learn more about consuming [Design Tokens](/styled-system/theme/).
