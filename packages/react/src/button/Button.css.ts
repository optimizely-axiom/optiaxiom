    ...
    colorScheme: {
      danger: style({
        vars: {
          ...
          [pressedAccentColorVar]: theme.colors["bg.error.strong.pressed"],
          [subtleHoverAccentColorVar]: theme.colors["bg.error"],
          [subtlePressedAccentColorVar]: theme.colors["bg.error.hovered"],
        },
      }),
      neutral: style({
        vars: {
          ...
          [subtlePressedAccentColorVar]: theme.colors["bg.neutral.hovered"],
      ...
      primary: style({
        vars: {
          ...
          [pressedAccentColorVar]: theme.colors["bg.accent.strong.pressed"],
          [subtleHoverAccentColorVar]: theme.colors["bg.accent"],
          [subtlePressedAccentColorVar]: theme.colors["bg.accent.hovered"],
        },
      }),
    },
    iconOnly: {
