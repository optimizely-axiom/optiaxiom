...
export const colors = {
  ...
  "bg.brand.solid.pressed": colorPalette["brand.700"],
  ...
  "bg.error.solid.pressed": colorPalette["red.700"],
  ...
  "bg.neutral.hover": colorPalette["neutral.1200/8"],
  "bg.neutral.inverse": colorPalette["neutral.800"],
  "bg.neutral.inverse.hover": colorPalette["neutral.900"],
  "bg.neutral.inverse.pressed": colorPalette["neutral.1000"],
...
export const colorsDark = {
  ...
  "bg.neutral.inverse.pressed": colorPalette["neutral.300"],
