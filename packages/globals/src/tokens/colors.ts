...
export const colors = {
  ...
  "bg.neutral.inverse.hovered": colorPalette["neutral.900"],
  "bg.neutral.strong": colorPalette["neutral.200"],
  "bg.neutral.strong.hovered": colorPalette["neutral.300"],
...
export const colorsDark = {
  ...
  "bg.neutral.inverse.hovered": colorPalette["neutral.200"],
  "bg.neutral.strong": colorPalette["neutral.100"],
  "bg.neutral.strong.hovered": colorPalette["neutral.800"],
  ...
  "fg.accent.hovered": colorPalette["neutral.00"],
