...
export const colors = {
  ...
  "bg.avatar.cyan": ld(palette["cyan.100"], palette["cyan.900"]),
  "bg.avatar.magenta": ld(palette["magenta.100"], palette["magenta.900"]),
  "bg.avatar.purple": ld(palette["purple.100"], palette["purple.900"]),
  ...
  "bg.spinner": ld(palette["neutral.1200/4"], palette["neutral.50/6"]),
  "bg.spinner.inverse": ld(palette["neutral.50/6"], palette["neutral.50/6"]),
  ...
  "fg.avatar.cyan": ld(palette["cyan.700"], palette["cyan.200"]),
  "fg.avatar.magenta": ld(palette["magenta.700"], palette["magenta.200"]),
  "fg.avatar.purple": ld(palette["purple.700"], palette["purple.200"]),
  "fg.default": ld(palette["neutral.800"], palette["neutral.75"]),
  "fg.default.inverse": ld(palette["neutral.00"], palette["neutral.800"]),
  "fg.disabled": ld(palette["neutral.1200/32"], palette["neutral.50/32"]),
  ...
  "fg.link": ld(palette["brand.500"], palette["brand.300"]),
  "fg.link.hovered": ld(palette["brand.600"], palette["brand.500"]),
  "fg.link.visited": ld(palette["purple.500"], palette["brand.300"]),
