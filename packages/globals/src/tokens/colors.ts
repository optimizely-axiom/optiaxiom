...
export const colors = {
  ...
  "avatar.bg.neutral": ld(palette["neutral.100"], palette["neutral.800"]),
  "avatar.bg.purple": ld(palette["purple.100"], palette["purple.800"]),
  "avatar.fg.neutral": ld(palette["neutral.700"], palette["neutral.100"]),
  "avatar.fg.purple": ld(palette["purple.700"], palette["purple.100"]),
  ...
  "bg.secondary.hovered": ld(
    palette["neutral.1200/8"],
    palette["neutral.50/12"],
  ),
  ...
  "link.fg.default": ld(palette["brand.500"], palette["brand.400"]),
  "link.fg.default.hovered": ld(palette["brand.600"], palette["brand.200"]),
  "link.fg.inverse": ld(palette["neutral.00"], palette["neutral.00"]),
  "link.fg.subtle": ld(palette["neutral.800"], palette["neutral.800"]),
  "link.fg.visited": ld(palette["purple.600"], palette["purple.500"]),

  "spinner.bg.default": ld(palette["neutral.1200"], palette["neutral.50"]),
  "spinner.bg.inverse": ld(palette["neutral.50"], palette["neutral.50"]),
  "spinner.fg.default": ld(palette["neutral.800"], palette["neutral.200"]),
  "spinner.fg.inverse": ld(palette["neutral.200"], palette["neutral.800"]),
} as const;
