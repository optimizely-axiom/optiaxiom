const palette = {
  ...
  "brand.dark.200": "#87a2f1" as const,
  "brand.dark.250": "#7998f6" as const,
  "brand.dark.350": "#4b7bf6" as const,
  "brand.dark.950": "#21283f" as const,
  ...
  "red.dark.400": "#E31818" as const,
  "red.dark.800": "#3d2222" as const,
  "red.dark.900": "#2d1f1f" as const,
  ...
  "yellow.dark.300": "#fcd34d" as const,
...
export const colors = {
  ...
  "bg.accent.hovered": ld(palette["brand.600"], palette["brand.dark.350"]),
  "bg.accent.light": ld(palette["brand.200"], palette["brand.800"]),
  "bg.accent.pressed": ld(palette["brand.700"], palette["brand.600"]),
  "bg.accent.subtle": ld(palette["brand.50"], palette["brand.dark.950"]),
  ...
  "bg.error.hovered": ld(palette["red.600"], palette["red.dark.400"]),
  "bg.error.light": ld(palette["red.200"], palette["red.700"]),
  "bg.error.pressed": ld(palette["red.700"], palette["red.600"]),
  "bg.error.subtle": ld(palette["red.50"], palette["red.900"]),
  ...
  "bg.secondary.hovered": ld(palette["neutral.1200/12"], palette["neutral.50/12"]),
  ...
  "bg.success.subtle": ld(palette["green.100"], palette["green.dark.900"]),
  "bg.tertiary": ld(palette["neutral.150"], palette["neutral.750"]),
  "bg.tertiary.hovered": ld(palette["neutral.200"], palette["neutral.700"]),
  "bg.warning": ld(palette["yellow.500"], palette["yellow.500"]),
  ...
  "border.default": ld(palette["neutral.200"], palette["neutral.750"]),
  "border.disabled": ld(palette["neutral.75"], palette["neutral.800"]),
  "border.error": ld(palette["red.500"], palette["red.dark.300"]),
  "border.focus": ld(palette["brand.400"], palette["brand.300"]),
  "border.focus.error": ld(palette["red.400"], palette["red.300"]),
  "border.secondary": ld(palette["neutral.150"], palette["neutral.850"]),
  "border.success": ld(palette["green.500"], palette["green.500"]),
  "border.tertiary": ld(palette["neutral.100"], palette["neutral.950"]),
  "border.warning": ld(palette["yellow.500"], palette["yellow.500"]),

  "fg.accent": ld(palette["brand.500"], palette["brand.300"]),
  "fg.accent.hovered": ld(palette["brand.600"], palette["brand.dark.350"]),
  "fg.accent.strong": ld(palette["brand.700"], palette["brand.dark.250"]),
  "fg.avatar.neutral": ld(palette["neutral.700"], palette["neutral.100"]),
  "fg.avatar.purple": ld(palette["purple.700"], palette["purple.100"]),
  "fg.default": ld(palette["neutral.800"], palette["neutral.175"]),
  "fg.default.inverse": ld(palette["neutral.00"], palette["neutral.800"]),
  "fg.disabled": ld(palette["neutral.500"], palette["neutral.500"]),
  "fg.error": ld(palette["red.500"], palette["red.dark.200"]),
  "fg.error.hovered": ld(palette["red.600"], palette["red.dark.200"]),
  "fg.error.light": ld(palette["red.300"], palette["red.dark.200"]),
  "fg.error.strong": ld(palette["red.700"], palette["red.dark.200"]),
  "fg.information": ld(palette["blue.500"], palette["blue.dark.200"]),
  "fg.information.light": ld(palette["blue.300"], palette["blue.dark.200"]),
  "fg.information.strong": ld(palette["blue.700"], palette["blue.dark.200"]),
  "fg.link.default": ld(palette["brand.500"], palette["brand.dark.200"]),
  "fg.link.default.hovered": ld(
    palette["brand.600"],
    palette["brand.dark.250"],
  ),
  "fg.link.inverse": ld(palette["neutral.00"], palette["neutral.800"]),
  "fg.link.subtle": ld(palette["neutral.800"], palette["neutral.175"]),
  "fg.link.visited": ld(palette["purple.600"], palette["purple.500"]),
  "fg.secondary": ld(palette["neutral.700"], palette["neutral.250"]),
  ...
  "fg.success": ld(palette["green.500"], palette["green.dark.200"]),
  "fg.success.hovered": ld(palette["green.600"], palette["green.dark.200"]),
  "fg.success.light": ld(palette["green.300"], palette["green.dark.200"]),
  "fg.success.strong": ld(palette["green.700"], palette["green.dark.200"]),
  "fg.tertiary": ld(palette["neutral.600"], palette["neutral.450"]),
  "fg.warning": ld(palette["yellow.500"], palette["yellow.dark.300"]),
  "fg.warning.hovered": ld(palette["yellow.600"], palette["yellow.dark.300"]),
  "fg.warning.inverse": ld(palette["neutral.800"], palette["neutral.800"]),
  "fg.warning.light": ld(palette["yellow.300"], palette["yellow.dark.300"]),
  "fg.warning.strong": ld(palette["yellow.700"], palette["yellow.dark.300"]),
